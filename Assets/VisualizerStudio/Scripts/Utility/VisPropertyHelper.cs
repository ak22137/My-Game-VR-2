        ...
        switch (targetProperty)
        {
            ...
            case GameObjectProperty.XVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.linearVelocity = new Vector3(propertyValue, 
							                                 	rigidbodyComp.linearVelocity.y, 
							                                 	rigidbodyComp.linearVelocity.z);
            ...
            case GameObjectProperty.YVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.linearVelocity = new Vector3(rigidbodyComp.linearVelocity.x, 
							                                 	propertyValue, 
							                                 	rigidbodyComp.linearVelocity.z);
				else if (gameObject.transform !=  null)
